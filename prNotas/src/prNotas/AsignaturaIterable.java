...
public class AsignaturaIterable implements Iterable{
	private String nombre;
	private String[] erroneos;
	private Alumno[] alumnos; 
	
	public AsignaturaIterable(String nombres, String[] array){
		nombre = nombres;
	...
	private class VisitadorAlumnos implements Iterator<Alumno>{
		private int pos=0;
